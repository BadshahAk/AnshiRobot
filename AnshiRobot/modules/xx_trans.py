...
from AnshiRobot import OWNER_ID, dispatcher
from AnshiRobot import pbot as client

Anshi = "https://files.catbox.moe/1nbg8u.jpg"
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        media=InputMediaVideo("https://files.catbox.moe/tonbus.mp4", has_spoiler=True),
        reply_markup=InlineKeyboardMarkup(
            [
                [close_button]
            ]
