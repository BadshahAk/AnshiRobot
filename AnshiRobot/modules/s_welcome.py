...
from AnshiRobot.database.wel_db import *
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("AnshiRobot/resources/bg.jpg")
    ...
    font = ImageFont.truetype('AnshiRobot/resources/SwanseaBold-D0ox.ttf', size=44)
    welcome_font = ImageFont.truetype('AnshiRobot/resources/SwanseaBold-D0ox.ttf', size=90)
