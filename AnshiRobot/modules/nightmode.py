...
from AnshiRobot import (
    BOT_NAME,
    BOT_USERNAME)
from AnshiRobot import telethn as tbot
from AnshiRobot.events import register
from AnshiRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
