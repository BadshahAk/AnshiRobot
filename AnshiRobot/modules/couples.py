...
from AnshiRobot.mongo.couples_db import _get_image, get_couple

Anshi = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ",
            url=f"https://t.me/AnshiRobot?startgroup=true",
        ),
    ],
]
def dt():
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "AnshiRobot/Love/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "AnshiRobot/Love/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("AnshiRobot/Love/HMMM.jpg")
...
"""
         ...
         await message.reply_photo(f"test_{cid}.png", caption=TXT, reply_markup=InlineKeyboardMarkup(Anshi),
    )
         await msg.delete()
