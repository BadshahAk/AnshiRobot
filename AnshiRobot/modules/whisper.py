    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://files.catbox.moe/zom5sd.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💌 ᴡʜɪsᴘᴇʀ",
            description=f"@AnshiRobot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**⬤ ᴜsᴀɢᴇ ➥**\n\n@AlisaMusicRobot (ᴛᴀʀɢᴇᴛ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ) (ʏᴏᴜʀ ᴍᴇssᴀɢᴇ).\n\n**๏ ᴇxᴀᴍᴘʟᴇ ➠**\n@AnshiRobot @username You Are So Cute"),
            thumb_url="https://files.catbox.moe/zom5sd.jpg",
            reply_markup=switch_btn
        )
    ]
...
⬤ @AnshiRoBot [@username] || [id] ʏᴏᴜʀ ᴍᴇssᴀɢᴇ
"""
